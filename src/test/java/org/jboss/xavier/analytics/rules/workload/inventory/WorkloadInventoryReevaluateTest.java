...
public class WorkloadInventoryReevaluateTest extends BaseIntegrationTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {"SUSE Linux Enterprise 12 (64-bit)", new ArrayList<>(Arrays.asList("No_Flag_Supported_OS")), null, WorkloadInventoryReportModel.COMPLEXITY_EASY, new HashSet<>(Arrays.asList(WorkloadInventoryReportModel.TARGET_RHV, WorkloadInventoryReportModel.TARGET_OSP)), new HashSet<>(Arrays.asList(WorkloadInventoryReportModel.TARGET_RHV, WorkloadInventoryReportModel.TARGET_OSP))},
                {"Oracle Linux 6 (64-bit)", new ArrayList<>(Arrays.asList("No_Flag_Convertible_OS")), null, WorkloadInventoryReportModel.COMPLEXITY_MEDIUM, new HashSet<>(Arrays.asList(WorkloadInventoryReportModel.TARGET_RHV, WorkloadInventoryReportModel.TARGET_OSP, "RHEL")), new HashSet<>(Arrays.asList(WorkloadInventoryReportModel.TARGET_RHV, WorkloadInventoryReportModel.TARGET_OSP, "RHEL"))},
                ...
                {"Red Hat Enterprise Linux 5 (64-bit)", new ArrayList<>(Arrays.asList("Target_OCP_Reevaluate", "One_Flag_Supported_OS")), Collections.singleton(WorkloadInventoryReportModel.SHARED_DISK_FLAG_NAME), WorkloadInventoryReportModel.COMPLEXITY_MEDIUM, new HashSet<>(Arrays.asList(WorkloadInventoryReportModel.TARGET_RHV)), new HashSet<>(Arrays.asList(WorkloadInventoryReportModel.TARGET_RHV, WorkloadInventoryReportModel.TARGET_OCP))},
                {"CentOS 7 (64-bit)", new ArrayList<>(Arrays.asList("One_Or_More_Flags_Convertible_OS")), new HashSet<>(Arrays.asList(WorkloadInventoryReportModel.SHARED_DISK_FLAG_NAME, WorkloadInventoryReportModel.CPU_AFFINITY_FLAG_NAME)), WorkloadInventoryReportModel.COMPLEXITY_HARD, new HashSet<>(Arrays.asList(WorkloadInventoryReportModel.TARGET_RHV, "RHEL")), new HashSet<>(Arrays.asList(WorkloadInventoryReportModel.TARGET_RHV, "RHEL"))},
                ...
                {"Microsoft Windows 7 (64-bit)", new ArrayList<>(Arrays.asList("One_Flag_Supported_OS")), new HashSet<>(Arrays.asList(WorkloadInventoryReportModel.RDM_DISK_FLAG_NAME)), WorkloadInventoryReportModel.COMPLEXITY_MEDIUM, new HashSet<>(Arrays.asList(WorkloadInventoryReportModel.TARGET_RHV, WorkloadInventoryReportModel.TARGET_OCP)), new HashSet<>(Arrays.asList(WorkloadInventoryReportModel.TARGET_RHV, WorkloadInventoryReportModel.TARGET_OCP))},
    ...
    {
        super("WorkloadInventoryReevaluateKSession0", "org.jboss.xavier.analytics.rules.*", 12);
    }
